...
/***/ function(module, exports, __webpack_require__) {
	...
	var componentController = __webpack_require__(6);
	...
	var app = {        
	    ...
	    load: function (e) {
	        ...
	        var motion = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./camera.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./camera.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "<div>\r\n    <h1>Camera Plugin</h1>    \r\n</div> \r\n \r\n<div id=\"camera\" class=\"container\">\r\n    <form>\r\n        <div class=\"form-group\">\r\n            <div class=\"row\">\r\n                <label>Select an image source</label>\r\n            </div>\r\n                \r\n            <div class=\"row btn-group\" data-toggle=\"buttons\">                        \r\n                <label for=\"optCamera\" class=\"btn btn-primary active\">\r\n                    <input type=\"radio\" name=\"imageRadio\" value=\"Camera\" id=\"optCamera\" checked>Camera\r\n                </label>                                                \r\n                        \r\n                <label for=\"optLibrary\" class=\"btn btn-primary\">\r\n                    <input type=\"radio\" name=\"imageRadio\" value=\"Library\" id=\"optLibrary\">Library\r\n                </label>                                                                \r\n            </div>    \r\n        </div>                \r\n         \r\n        <div class=\"form-group\">\r\n            <div class=\"row\">\r\n                <button id=\"getImage\" type=\"button\" class=\"btn\">Get an image</button>    \r\n            </div>\r\n            <div class=\"row\">\r\n                <figure>\r\n                    <img id=\"image\">\r\n                </figure>    \r\n            </div>    \r\n        </div>                                                         \r\n    </form>     \r\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./motion.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./motion.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
